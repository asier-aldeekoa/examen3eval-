...
public class Principal {
	...
	private static void mostrarMenu(int nivel) {
		...
		do {
			...
			switch (opcion) {
			case 1:
				LOGGER.log(Level.FINE, "1 Aukera");
				nivel = leerNivelAgua();
				permiso = false;
				compuertasVerificadas = false;
				break;
			case 2:
				LOGGER.log(Level.FINE, "2 Aukera");
				if(abrirCompuertas()) {
					System.out.println();
				...
				break;
			case 3:	
				LOGGER.log(Level.FINE, "3 Aukera");
				...
				break;	
			case 4:
				LOGGER.log(Level.FINE, "4 Aukera");
	...
	/**
	 * @author AsierAldekoaGaray
	 * @param nivel genera un numero aleatorio entre 0 y 100
	 * @return Te devuelve un booleano diciendo si el nivel es mayor que 50
	 */
